...
#       temporary usage, ignoring the `-e` flag.
...
# Collect all arguments for the java command, stracks://issues.gradle.org/browse/GRADLE-2848
# and https://github.com/gradle/gradle/issues/27471
# For now, it must be hardcoded.
